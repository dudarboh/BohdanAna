...
double TrackLengthUtils::getHelixArcLengthTanL(const EVENT::TrackState& ts1, const EVENT::TrackState& ts2){
    double omega = ts1.getOmega();
...
std::vector<EVENT::SimTrackerHit*> TrackLengthUtils::convertHitsToSimHits(EVENT::LCEvent* evt, const std::vector<EVENT::Track*>& tracks, MarlinTrk::IMarlinTrkSystem* trkSystem, double bField){
...
EVENT::SimTrackerHit* TrackLengthUtils::getSimTrackerHit(EVENT::LCEvent* evt, EVENT::TrackerHit* hit){
