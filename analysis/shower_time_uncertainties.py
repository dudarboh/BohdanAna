...
df = ROOT.RDataFrame("treename", "/nfs/dust/ilc/user/dudarboh/tof/tof_studies.root").Filter("if (rdfentry_ % 1000000 == 0){ std::cout << rdfentry_ << std::endl; } return true;")
...
data = df.AsNumpy(["dtCylinder", "dtCylMedian", "dtMedianCylinder", "dtFrank"])
